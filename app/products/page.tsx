...
export const metadata: Metadata = { title: 'Solar products | Richa Enterprises', description: 'Explore the panels, inverters and storage systems selected by Richa Enterprises.' }
