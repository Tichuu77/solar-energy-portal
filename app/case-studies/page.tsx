...
export const metadata: Metadata = { title: 'Solar case studies | Surya Urja', description: 'Explore premium residential, commercial and industrial solar installations across Maharashtra.' }
